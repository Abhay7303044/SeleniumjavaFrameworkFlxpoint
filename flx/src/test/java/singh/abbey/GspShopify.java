...
public class GspShopify extends Base {
	...
	public void Gspshopify(String SourceName, String ChannelName, String ConnectionName, String MappingTemplate) throws InterruptedException {
	...
	String text= driver.findElement(By.xpath("//p[@class='message-body']/b")).getText();
	if(text.equalsIgnoreCase("Get Source Products")) {
	...
	public Object[][] getData_5() {
		...
		data[0][0] = "abhay demo 1.0";
		data[0][1] = "Shopify";
		data[0][2] = "Shopify Test";
		data[0][3] = "Shopify test template";
