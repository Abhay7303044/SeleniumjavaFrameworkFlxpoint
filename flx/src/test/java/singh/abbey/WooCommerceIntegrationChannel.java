...
public class WooCommerceIntegrationChannel extends Base {
	...
	public void IntegrationChannel() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys("abhi testing woo");
		Thread.sleep(2000);
		...
		for (int i = 0; i < option.size(); i++) {
			if (option.get(i).getText().contains("abhi testing woo")) {
		...
		select3.selectByVisibleText("WooCommerce"); // publish/overwrite
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("//input[@class='input']")).sendKeys("WooCommerce connection");
		...
		driver.findElement(By.xpath("//input[@name='consumer-key']")).sendKeys("ck_086c509c91e3a216bb790a8b2896dafe8d7b1984");
		driver.findElement(By.xpath("//input[@name='consumer-secret']")).sendKeys("cs_52ba579c56a15c2317730b97e952fac68fb08617");
		driver.findElement(By.xpath("//input[@name='domain']")).sendKeys("https://wordpress.shopping-carts.inventorysource.com");  
		...
		select5.selectByVisibleText("woocommerce publish template");
		Thread.sleep(1000);
	...
	//-------------------------sync product ------------------------------------
		...
		select6.selectByVisibleText("WooCommerce");
		Thread.sleep(1000);
		...
		select7.selectByVisibleText("WooCommerce connection");
		Thread.sleep(1000);
		...
		select8.selectByVisibleText("Sync Products template");
		Thread.sleep(1000);
	...
	//-----------------------------get order---------------------------------------------------------
		...
		select9.selectByVisibleText("WooCommerce");
		Thread.sleep(1000);
		...
		select10.selectByVisibleText("WooCommerce connection");
		Thread.sleep(1000);
	...
	//-----------------------sync order ------------------------------------------------
		...
		select12.selectByVisibleText("WooCommerce");
		Thread.sleep(1000);
		...
		select13.selectByVisibleText("WooCommerce connection");
		Thread.sleep(1000);
		...
		select14.selectByVisibleText("Sync Orders template");
		Thread.sleep(1000);
